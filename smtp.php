...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Sindre Design")
{
      ...
      $admin_email = 'info@ninhbinhcoop.com';//User duoc khai bao tren mail server
      $smtp_username = 'info@ninhbinhcoop.com';//User duoc khai bao tren mail server
      $smtp_password = 'htx873557';//Pass cua email nay
...
//Test send mail
SendMail("info@ninhbinhcoop.com","nguyentruonggiang91@gmail.com","Details of Booking Form","Content Testing");
