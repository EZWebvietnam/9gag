<?php
class google{
	public $client_id = '957752117319-navphphkvrojmn5hi44s2b5eur14nsop.apps.googleusercontent.com';
	public $client_secret = 'a-zolW-tXBD88mWlc1VByO2K';
	...
	public function getAccessToken($redirect_uri = null){
		if(empty($this->accessToken)){
			$accessToken = $this->post($this->DOMAIN_MAP['token'], array(
				'code' => $_REQUEST['code'],
				'client_id' => $this->client_id,
