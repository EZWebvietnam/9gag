...
<div class="badge-page page">
            <div class="main-wrap">
             ...
             <div class="loading">
                    <div class="animation_image" style="display:none;"><img src="<?php echo base_url();?>template/ezwebvietnam/home/9gag/img/ajax-loader.gif"> Loading...</div>
                     <a class="btn badge-load-more-post" data-loading-text="Loading more posts...">Load more posts</a>
                  </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#result_load').load("<?php echo base_url();?>home/member/fetch_post", {'page':track_click}, function() {track_click++;});
    ...
    $(".btn").click(function (e) { 
        ...
        if(track_click <= total_pages-1)
        {
            ...
            $.post('<?php echo base_url();?>home/member/fetch_post',{'page': track_click}, function(data) {
            
               $(".btn").attr("style", "display:block");
                
                $("#result_load").append(data); 
                
                
                $("html, body").animate({scrollTop: $(".btn").offset().top}, 500);
                
                
                $('.animation_image').attr("style", "display:none");
