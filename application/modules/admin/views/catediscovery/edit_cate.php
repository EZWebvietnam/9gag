...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Sửa danh mục</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" id='view' method="post">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused" name='cate'  type="text" value="<?php echo $detail[0]['name']?>">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                           ...
                           {
                            if($detail[0]['parent']==$list_prj['id'])
                            {
                           ?>
                           <option selected="" value="<?php echo $list_prj['id']?>"><?php echo $list_prj['name']?></option>
                           <?php } else { ?> 
