                        ...
                        <header>
                           <h2 class="badge-item-title">
                              <a class="badge-evt badge-track"
                                 ...
                                 href="<?php echo base_url();?><?php echo mb_strtolower(url_title(removesign($post['name_cate'])))?>-c<?php echo $post['id_cate']?>/<?php echo mb_strtolower(url_title(removesign($post['title'])))?>-p<?php echo $post['id_post']?>"
                                 target="_blank">
