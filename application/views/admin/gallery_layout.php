                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/car"><i class="icon-globe"></i><span class="hidden-tablet">Liệt kê xe</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/car/car_bus"><i class=" icon-cog"></i><span class="hidden-tablet">Xe - Tuyến xe</span></a></li>
                        </ul>
